...
var app = (function () {
    			...
    			if (!mounted) {
    				dispose = [
    					listen_dev(
    						...
    						"mouseenter",
    						function () {
    							if (is_function(/*onHover*/ ctx[0].bind(this, /*name*/ ctx[3]))) /*onHover*/ ctx[0].bind(this, /*name*/ ctx[3]).apply(this, arguments);
    						},
    						false,
    						false,
    						false
    					...
    					listen_dev(
    						...
    						"mouseleave",
    						function () {
    							if (is_function(/*onUnhover*/ ctx[1].bind(this, /*name*/ ctx[3]))) /*onUnhover*/ ctx[1].bind(this, /*name*/ ctx[3]).apply(this, arguments);
    						},
    						false,
    						false,
    						false
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	$$self.$$set = $$props => {
    		...
    		if ('onUnhover' in $$props) $$invalidate(1, onUnhover = $$props.onUnhover);
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(b, "class", "svelte-1aukf2s");
    			add_location(b, file, 41, 32, 1042);
    			attr_dev(div0, "class", "align-left svelte-1aukf2s");
    			add_location(div0, file, 41, 8, 1018);
    			attr_dev(div1, "class", "svelte-1aukf2s");
    			add_location(div1, file, 42, 8, 1073);
    			attr_dev(div2, "class", "align-right svelte-1aukf2s");
    			add_location(div2, file, 43, 8, 1103);
    			attr_dev(header, "class", "svelte-1aukf2s");
    			add_location(header, file, 40, 6, 1001);
    			attr_dev(br, "class", "svelte-1aukf2s");
    			add_location(br, file, 52, 31, 1555);
    			attr_dev(p, "class", "svelte-1aukf2s");
    			add_location(p, file, 46, 8, 1196);
    			attr_dev(aside, "class", "svelte-1aukf2s");
    			add_location(aside, file, 45, 6, 1180);
    			attr_dev(li0, "class", "svelte-1aukf2s");
    			add_location(li0, file, 58, 10, 1648);
    			attr_dev(li1, "class", "svelte-1aukf2s");
    			add_location(li1, file, 59, 10, 1777);
    			attr_dev(li2, "class", "svelte-1aukf2s");
    			add_location(li2, file, 60, 10, 1909);
    			attr_dev(ul, "class", "svelte-1aukf2s");
    			add_location(ul, file, 57, 8, 1633);
    			attr_dev(nav, "class", "svelte-1aukf2s");
    			add_location(nav, file, 56, 6, 1619);
    			attr_dev(span, "class", "lemonada svelte-1aukf2s");
    			add_location(span, file, 39, 4, 971);
    			attr_dev(section, "class", "svelte-1aukf2s");
    			add_location(section, file, 38, 2, 957);
    			attr_dev(main, "style", /*mainStyle*/ ctx[1]);
    			attr_dev(main, "class", "svelte-1aukf2s");
    		...
    		p: function update(ctx, [dirty]) {
    			if ((!current || dirty & /*time*/ 1) && t4_value !== (t4_value = /*time*/ ctx[0].toLocaleString() + "")) set_data_dev(t4, t4_value);
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	function setSwatch(newSwatch) {
    		swatch = newSwatch;
    		$$invalidate(1, mainStyle = `--theme-day: ${swatch.day}; --theme-night: ${swatch.night}`);
    	}
